...
- Name: explore-results-mode.spec.ts >> Explore hides discovery content while a category filter is active
- Location: tests\e2e\explore-results-mode.spec.ts:19:1
