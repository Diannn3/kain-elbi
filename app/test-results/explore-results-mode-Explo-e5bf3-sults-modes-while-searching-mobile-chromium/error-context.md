...
- Name: explore-results-mode.spec.ts >> Explore switches between discovery and results modes while searching
- Location: tests\e2e\explore-results-mode.spec.ts:3:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4322/explore
Call log:
  - navigating to "http://127.0.0.1:4322/explore", waiting until "load"
