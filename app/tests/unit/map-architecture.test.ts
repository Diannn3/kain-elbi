...
describe('online Carto architecture', () => {
	...
	it('configures MapLibre with Carto Voyager and no PMTiles protocol', () => {
		...
		expect(canvas).toContain('https://basemaps.cartocdn.com/gl/voyager-gl-style/style.json');
