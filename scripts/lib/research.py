...
def make_observation(
    ...
    *,
    ...
    captured = parse_datetime(raw.get("captured_at") or isoformat_z(now or utc_now()), field="captured_at")
    ...
    if source_identity is not None:
        ...
        source_identity = source_identity.strip()[:200] or None
